...
/* ---------- visual polish only (no layout or behaviour changes) ------ */
...
/* Expanders and forms: one subtle container style */
...
/* Thinner, less shouty section rules */
hr, [data-testid="stDivider"] hr {
    border-color: rgba(255,255,255,0.09) !important;
    margin: 1.1rem 0 !important;
}

/* Softer corners on tables and the map frame */
