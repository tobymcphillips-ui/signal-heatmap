...
st.title("📡 GPS Signal Heatmap — Course Coverage Analyzer")
st.caption(
    "Pulls every round's fixes for a date range, measures the delay between "
    "device-recorded time and server-received time, and maps where on the "
    "course the signal drops out."
)
...
with right:
    ...
    if show_markers and not bad.empty:
        ...
        for _, r in worst.iterrows():
            folium.CircleMarker(
                [r["lat"], r["lon"]], radius=5, color="#ff3333",
